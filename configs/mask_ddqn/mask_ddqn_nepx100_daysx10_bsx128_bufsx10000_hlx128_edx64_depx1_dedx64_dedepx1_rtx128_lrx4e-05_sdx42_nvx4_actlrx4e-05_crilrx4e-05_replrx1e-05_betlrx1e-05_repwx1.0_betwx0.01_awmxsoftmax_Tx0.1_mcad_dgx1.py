root = None
workdir = 'workdir'
tag = 'mask_ddqn_nepx100_daysx10_bsx128_bufsx10000_hlx128_edx64_depx1_dedx64_dedepx1_rtx128_lrx4e-05_sdx42_nvx4_actlrx4e-05_crilrx4e-05_replrx1e-05_betlrx1e-05_repwx1.0_betwx0.01_awmxsoftmax_Tx0.1_mcad_dgx1'
num_stocks = 7
num_envs = 4
discretized_low = 0
discretized_high = 10
...
scheduler = dict(
    ...
    multi_steps=[512000, 716800, 921600],
    t_initial=1024000,
    decay_t=512000,
    gamma=0.1,
    t_mul=1.0,
    ...
    noise_seed=42,
    initialize=True)
optimizer = dict(type='AdamW', params=None, lr=4e-05)
agent = dict(
    type='AgentMaskDQN',
    act_lr=4e-05,
    cri_lr=4e-05,
