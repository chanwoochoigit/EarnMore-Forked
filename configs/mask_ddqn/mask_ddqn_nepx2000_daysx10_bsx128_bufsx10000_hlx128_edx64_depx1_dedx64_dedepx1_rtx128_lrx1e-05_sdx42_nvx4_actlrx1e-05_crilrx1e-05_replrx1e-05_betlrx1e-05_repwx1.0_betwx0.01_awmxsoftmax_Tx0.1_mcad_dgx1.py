root = None
workdir = "workdir"
tag = "mask_ddqn_nepx2000_daysx10_bsx128_bufsx10000_hlx128_edx64_depx1_dedx64_dedepx1_rtx128_lrx1e-05_sdx42_nvx4_actlrx1e-05_crilrx1e-05_replrx1e-05_betlrx1e-05_repwx1.0_betwx0.01_awmxsoftmax_Tx0.1_mcad_dgx1"
num_stocks = 7
num_envs = 4
discretized_low = 0
discretized_high = 10
...
scheduler = dict(
    ...
    multi_steps=[384000, 640000, 896000],
    t_initial=1024000,
    decay_t=512000,
    gamma=0.1,
    t_mul=1.0,
