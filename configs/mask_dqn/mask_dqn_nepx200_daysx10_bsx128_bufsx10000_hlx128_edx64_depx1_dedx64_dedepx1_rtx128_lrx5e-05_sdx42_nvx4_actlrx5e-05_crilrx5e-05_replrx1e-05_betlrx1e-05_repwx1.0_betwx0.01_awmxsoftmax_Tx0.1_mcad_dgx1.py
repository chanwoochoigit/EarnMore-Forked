root = None
workdir = 'workdir'
tag = 'mask_dqn_nepx200_daysx10_bsx128_bufsx10000_hlx128_edx64_depx1_dedx64_dedepx1_rtx128_lrx5e-05_sdx42_nvx4_actlrx5e-05_crilrx5e-05_replrx1e-05_betlrx1e-05_repwx1.0_betwx0.01_awmxsoftmax_Tx0.1_mcad_dgx1'
num_stocks = 7
num_envs = 4
discretized_low = 0
discretized_high = 10
...
scheduler = dict(
    ...
    noise_seed=42,
    initialize=True)
optimizer = dict(type='AdamW', params=None, lr=5e-05)
agent = dict(
    type='AgentMaskDQN',
    act_lr=5e-05,
    cri_lr=5e-05,
