root = None
workdir = 'workdir'
tag = 'mask_sac_nepx100_daysx10_bsx128_bufsx10000_hlx128_edx64_depx1_dedx64_dedepx1_rtx128_lrx0.0003_sdx42_nvx4_actlrx0.0003_crilrx0.0003_replrx0.0003_betlrx0.0003_repwx1.0_betwx0.01_awmxsoftmax_Tx0.1_mcad_dgx0'
num_stocks = 7
num_envs = 4
num_features = 102
temporal_dim = 3
...
scheduler = dict(
    ...
    noise_seed=42,
    initialize=True)
optimizer = dict(type='AdamW', params=None, lr=0.0003)
agent = dict(
    type='AgentMaskSAC',
    act_lr=0.0003,
    cri_lr=0.0003,
