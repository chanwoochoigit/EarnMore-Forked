root = None
workdir = 'workdir'
tag = 'mask_sac_nepx150_daysx10_bsx128_bufsx10000_hlx128_edx64_depx1_dedx64_dedepx1_rtx128_lrx0.0001_sdx42_nvx4_actlrx0.0001_crilrx0.0001_replrx0.0001_betlrx0.0001_repwx1.0_betwx0.01_awmxsoftmax_Tx0.1_mcad_dgx0'
num_stocks = 7
num_envs = 4
num_features = 102
temporal_dim = 3
...
scheduler = dict(
    ...
    noise_seed=42,
    initialize=True)
optimizer = dict(type='AdamW', params=None, lr=0.0001)
agent = dict(
    type='AgentMaskSAC',
    act_lr=0.0001,
    cri_lr=0.0001,
